...
//     binary search tree.  The reference parameter, removed, has been set to
//     a copy of the removed item.
//
//   template <class Item>
//   void insert(binary_tree_node<Item>*& root_ptr, const Item& entry);
//     Postcondition: entry is now the child leaf of the entry closest in
//     value to it.  It is a right child if its larger than the parent,
//     and a left child if it is smaller
//
//   template <class Item, class SizeType>
//   void create_balanced(binary_tree_node<Item>*& root_ptr, Item* values,
//        SizeType first, SizeType size);
//     Precondition: The size of the array must be equal to variable size
//     Postcondition: returns a balanced bst containting the values 
//     stored in values.
